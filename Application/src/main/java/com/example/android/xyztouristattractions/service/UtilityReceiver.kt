 ...
 * [com.example.android.xyztouristattractions.service.UtilityService].
 */
class UtilityReceiver : WakefulBroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // notification.
        intent.setClass(context, UtilityService::class.java)
        intent.action = UtilityService.ACTION_GEOFENCE_TRIGGERED
